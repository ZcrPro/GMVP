...
import com.google.zxing.client.android.RotationLuminanceSource;
...
public final class CameraManager {
     ...
     */
    public RotationLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return new RotationLuminanceSource(data, width, height, 0, 0,
                    width, height);
        } else {
            return new RotationLuminanceSource(data, width, height, rect.left, rect.top,
